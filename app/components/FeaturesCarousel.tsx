    ...
    <div className="font-sans">
      <div className="carousel-padding">
        <div ref={ref} className="keen-slider mb-8 ">
          <div
            className={cn(
              "keen-slider__slide number-slide-0 rounded-project relative border border-light-grey hover:border-mid-grey/50 text-white h-full",
            ...
            >
              <div className="flex flex-col space-y-4 lg:space-y-6">
                <h3 className="text-[20px] font-semibold font-sans">
                  Jeg støtter og heier <br className="" /> på deg gjennom <br />{" "}
                  hele reisen
                </h3>
          ...
          <div
            className={cn(
              "keen-slider__slide number-slide-1 rounded-project relative border border-mid-grey/25 hover:border-mid-grey/50 bg-white text-black",
              currentSlide === 1 && "mx-4 lg:mx-0"
            )}
          >
            <AspectRatio
              ratio={aspectRatio}
              className="flex flex-col space-y-9 lg:space-y-6"
            >
              <div className="flex flex-col space-y-6 px-6 py-8 pb-2">
          ...
          <div
            className={cn(
              "keen-slider__slide number-slide-2 rounded-project relative border border-[#DEF7FF] hover:border-mid-grey/50 bg-[#DEF7FF] text-black",
          ...
          >
            ...
            >
              <div className="flex flex-col space-y-3 lg:space-y-6">
                ...
                <p className="text-[20px] font-light text-pretty max-w-[80%]">
              ...
              <Image
                className="absolute bottom-0 w-1/2 lg:w-2/5 z-[-1]"
                width={400}
                height={800}
          ...
          <div
            className={cn(
              "keen-slider__slide number-slide-3 rounded-project relative border border-[#FEE9F1] hover:border-mid-grey/50 bg-[#FEE9F1] text-black",
          ...
          <div
            className={cn(
              "keen-slider__slide number-slide-4 rounded-project relative border border-[#FEE9F1] hover:border-mid-grey/50 text-black h-full",
              currentSlide === 4 && "mx-4 lg:mx-0"
            )}
          >
            <AspectRatio
              ratio={aspectRatio}
              className="py-8 pb-6 px-6 flex flex-col justify-between text-white h-full"
            >
          ...
          <div
            className={cn(
              "keen-slider__slide number-slide-5 rounded-project relative border border-mid-grey/25 hover:border-mid-grey/50 bg-white text-black",
              currentSlide === 5 && "mx-4 lg:mx-0"
            )}
          >
            <AspectRatio
              ratio={aspectRatio}
              className="py-8 pb-6 mx-6 flex flex-col justify-between"
            >
              <div className="flex flex-col space-y-3 lg:space-y-6">
                <h3 className="text-[20px] font-semibold font-sans">
                  Du er ikke alene
          ...
          <div
            className={cn(
              "keen-slider__slide number-slide-6 rounded-project relative border border-pink-mid hover:border-mid-grey/50 text-black bg-[#F5BECE] h-full",
