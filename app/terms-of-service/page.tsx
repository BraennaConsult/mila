...
import { COMPANY_NAME, CONTACT_EMAIL, PHONE_NUMBER } from "@/constants";
        ...
        <Section>
          <Container className="lg:max-w-2xl">
            ...
            <article className="prose lg:prose-xl">
              ...
              <h2>2. Partene</h2>
              <p>
                Selger er {COMPANY_NAME}, Orgnr. 926 756 435, Hamrevegen 25 G,
                5229 Kalandseidet,{" "}
            ...
            <p>
              ...
              delivery time, shipping policy and a return policy aligned with
              the Distance Contracts Act with information about 14 day right to
              return. If shipping fees are added, the price needs to be clearly
              specified.{" "}
              <Link
